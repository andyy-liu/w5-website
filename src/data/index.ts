...
export const EVENTS: Event[] = [
  ...
  },
  {
    ...
    portfolio: "INNOVATION",
    image: "/events/internship-1.webp",
  ...
  },
  {
    ...
    register: "https://docs.google.com/forms/d/e/1FAIpQLSdBqOBipdXH7BwV2Ea_2brN8J8N5xJexkU9UxyPgVDa5-rQLw/viewform?usp=dialog",
    isRegistrationOpen: true,
    whatIs: "The Accelerator program is a hands-on program designed to guide aspiring entrepreneurs through the essential steps of building a successful startup. Participants are guided by industry experts and founders to explore concepts such as ideation and market research, building a program and scaling and growth. ",
  ...
  },
  {
    ...
    register: "https://docs.google.com/forms/d/e/1FAIpQLSe3rYnoSDAwok__YX76Wx1Of6esQjPr0BbpgUSsY76ldE3GcA/viewform?fbclid=IwY2xjawO_3npleHRuA2FlbQIxMQBzcnRjBmFwcF9pZAEwAAEeJohLp-MnhgcgzS1ERxR3iS-qrL5GITw9DozhXE8DPoJWjNtgyx2sx4heaaM_aem_Avx-0O21sphgTL4ByOxMGw",
    isRegistrationOpen: true,
  ...
  },
  {
    ...
    description: "An alternative pitch competition focused on student creativity and business feasibility, the capstone event where products from the Accelerator Program are showcased.",
    portfolio: "ACCELERATOR",
    image: "/events/pitch5.webp",
    register: "https://example.com/register-designathon",
    isRegistrationOpen: false,
  ...
  },
  {
    ...
    title: "Alchemy",
    date: "March 2026",
    description: "A celebration of student-led passion projects, bringing Western’s builders together for an evening of demos, creativity, and community.",
    portfolio: "CATALYST",
    image: "/events/alchemy-3.webp",
    register: "https://example.com/register-designathon",
    isRegistrationOpen: false,
    whatIs: "Alchemy is Western’s first passion project showcase, designed to highlight the work of students who create outside their academic and professional commitments. The event features live demos from Momentum’s builder community, on-stage presentations, and a science-fair–style exhibit where attendees can explore projects up close. The projects span AI tools, physics prototypes, visual art, and new creative frameworks—reflecting the range of ideas shaped at Momentum’s weekly co-working sessions. W5 supports Momentum in bringing this event to life, helping with the logistics and execution to spotlight these builders.",
    why: "Alchemy gives students a platform to share projects that rarely get seen—no judging, no rankings, and no pressure to compete. Attendees can meet builders, exchange ideas, and be inspired by the range of creativity within Western’s community. The event stands apart from competitions and hackathons by focusing on celebration, connection, and the culture of building at Western.",
    additionalDetails: "Date: March 2026 \n Time: TBA \n Location: Morrissette Institute for Entrepreneurship \n Cost: Free for all students \n Attendance: Open to all students from all universities.",
    images: ["/events/alchemy-1.webp", "/events/alchemy-2.webp", "/events/alchemy-3.webp", "/events/alchemy-4.webp", "/events/alchemy-5.webp", "/events/alchemy-6.webp", "/events/alchemy-7.webp", "/events/alchemy-8.webp", "/events/alchemy-9.webp"]
  },
  {
